...
import vn.iotstar.baitaptuan11_21110282_fragmenttablayoutviewpager2.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menuSearch) {
            Toast.makeText(this, "Bạn đang chọn tìm kiếm", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.menuSetting) {
            Toast.makeText(this, "Bạn đang chọn cài đặt", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.menuNewGroup) {
            Toast.makeText(this, "Bạn đang chọn nhóm mới", Toast.LENGTH_SHORT).show();
